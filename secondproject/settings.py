...
#SECRET_KEY = 'uq1#muojtn5k#)f*zbkgewc9!ma4d*r756hgl@n$wcw_ak-kc5'
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'uq1#muojtn5k#)f*zbkgewc9!ma4d*r756hgl@n$wcw_ak-kc5')
